                ...
                <div className="flex flex-col gap-4">
                     {
                        Object.entries(params).map(([key, value]) => {
                            if (key === '_id' || !value || !(key in taskData)) return null;
                            // key[0].toUpperCase() => met le premier caractère de la key en majuscule
                            // key.slice(1) => supprime le premier caractère de la key
                            // description devient Description
