...
export const ModalRecipe=({ open , title , initialRecipeData , onClose , onCreateRecipe , params} : IRecipeProps)=>{
        ...
        <div className="h-screen w-full bg-[#00000070] flex items-center justify-center  absolute top-0 left-0">
            <div className="bg-white rounded-3xl p-5 flex flex-col gap-8 w-1/2">
                ...
                <div className="flex items-center justify-end gap-4">
                    <button className="bg-red-400 text-white p-2 pl-6 pr-6 rounded-full " onClick={}>close</button>
                    <button className="bg-blue-700 text-white p-2 pr-6 pl-6 rounded-full"  onClick={}>save</button>
                </div>
            </div>
        </div>
    )
