        ...
        <div className="h-screen w-full bg-[#00000070] flex items-center justify-center  absolute top-0 left-0">
            <div className="bg-white rounded-3xl p-5 flex flex-col gap-8 w-1/2">
                ...
                <div className="flex flex-col gap-4">
                    <input className="border-2 border-[#00000070] rounded-3xl" type="text" name="title" id="title" placeholder="title" />
                    <input className="border-2 border-[#00000070] rounded-3xl" type="text" name="text" id="text" placeholder="text" />
                </div>
