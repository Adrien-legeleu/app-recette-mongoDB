        ...
        <div className="h-full w-full mt-12">
            ...
            <div className="grid grid-cols-3 gap-6 mt-8 pl-10 pr-10">
                {allRecipes.map((recipe: any) => (
                    <div key={`recipe : ${recipe._id}`} className="rounded-3xl bg-gray-100 gap-5 flex flex-col pb-5 pt-5 pr-10 pl-10 text-center" onClick={()=>onChangeRecipe({status:newStatus} , recipe._id)}> 
